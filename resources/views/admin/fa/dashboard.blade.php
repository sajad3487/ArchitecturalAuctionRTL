                            ...
                            <div class="card-header border-0 pt-5">
                                <div class="card-title">
                                    <div class="card-label">
                                        <div class="font-weight-bolder">دسترسی سریع</div>
                                    ...
                                    width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                            ...
                                            <div>
                                                <a href="{{url('/admin/users')}}"
                                                   class="font-size-h6 text-dark-75 text-hover-primary font-weight-bolder">مشتریان</a>
                                            </div>
                                        </div>
                                    ...
                                    width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                            ...
                                            <div>
                                                <a href="{{url('/admin/category')}}"
                                                   class="font-size-h6 text-dark-75 text-hover-primary font-weight-bolder">دسته بندی ها</a>
                                    ...
                                    width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                            ...
                                            <div>
                                                <a href="{{url('/admin/project')}}"
                                                   class="font-size-h6 text-dark-75 text-hover-primary font-weight-bolder">پروژه ها</a>
                            ...
                            <div class="col-xl-3">
                                ...
                                <div class="card card-custom bgi-no-repeat bgi-size-cover gutter-b"
                                    ...
                                    <div class="card-body d-flex flex-column">
                                        <!--begin::Title-->
                                        <a href="{{url('/admin/project')}}"
                                           class="text-white text-hover-primary font-weight-bolder font-size-h3">پروژه ها</a>
                                        <!--end::Title-->
                                    </div>
                                    <!--end::Body-->
                                </div>
                            ...
                            <div class="col-xl-9">
                                ...
                                <div class="card card-custom gutter-b" style="height: 150px">
                                    ...
                                    <div class="card-body d-flex align-items-center justify-content-between flex-wrap">
                                        <div class="mr-2">
                                            <h3 class="font-weight-bolder">ایجاد دسته بندی جدید</h3>
                                            {{--                                            <div class="text-dark-50 font-size-lg mt-2">--}}
                                            {{--                                                Generate the latest CRM Report--}}
                                            {{--                                            </div>--}}
                                        </div>
                                        <a href="{{'/admin/categories'}}"
                                           class="btn btn-primary font-weight-bold py-3 px-6">دسته بندی جدید</a>
                                    </div>
                                    <!--end::Body-->
                                </div>
                                <!--end::Mixed Widget 10-->
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <path
            ...
            fill="#000000" opacity="0.3"/>
                                                ...
                                                <a href="{{url('/admin/project')}}"
                                                   class="text-inverse-success font-weight-bold font-size-lg mt-1">همه پروژه ها</a>
                                            </div>
                                        </div>
                                        <!--end::Tiles Widget 11-->
                                    </div>
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <path
            ...
            fill="#000000" fill-rule="nonzero"/>
                                                ...
                                                <a href="{{url('/admin/users')}}"
                                                   class="text-muted text-hover-primary font-weight-bold font-size-lg mt-1">کاربران</a>
                                            </div>
                                        </div>
                                        <!--end::Tiles Widget 12-->
                                    </div>
                                ...
                                <div class="card card-custom bgi-no-repeat gutter-b"
                                    ...
                                    <div class="card-body d-flex align-items-center">
                                        <div>
                                            <h3 class="text-white font-weight-bolder line-height-lg mb-5">پروژه ها</h3>
                                            <a href='{{url('admin/project')}}' class="btn btn-success font-weight-bold px-6 py-3">نمایش</a>
                                        </div>
                                    </div>
                                    <!--end::Body-->
                                </div>
                                ...
                                <div class="card card-custom bgi-no-repeat bgi-size-cover gutter-b card-stretch"
                                    ...
                                    <div class="card-body d-flex flex-column align-items-start justify-content-start">
                                        <div class="p-1 flex-grow-1">
                                            <h3 class="text-white font-weight-bolder line-height-lg mb-5">پروژه های فعال</h3>
                                        </div>
