                                            ...
                                            <div class="card-title collapsed" data-toggle="collapse" data-target="#collapse-{{$category->id ?? ''}}">
                                                ...
                                                <div class="ml-10">
                                                    @if($category->status ==1 )
                                                        <span class="label font-weight-bold label-lg label-light-success label-inline">فعال</span>

                                                    @else
                                                        <span class="label font-weight-bold label-lg label-light-danger label-inline">غیرفعال</span>
