                    ...
                    <div class="row justify-content-center py-8 px-8 py-md-36 px-md-0 bg-primary">
                        <div class="col-md-9">
                            <div class="d-flex justify-content-between align-items-md-center flex-column flex-md-row">
                                ...
                                <h1 class="display-3 font-weight-boldest text-white order-1 order-md-2">فاکتور</h1>
                            </div>
                        </div>
                    </div>
                    <!--end::Invoice header-->
                        ...
                        <div class="col-md-9">
                            ...
                            <div class="row pb-10">
                                <div class="col-md-3 border-right-md pr-md-10 py-md-10">
                                    <!--begin::Invoice To-->
                                    <div class="text-dark-50 font-size-lg font-weight-bold mb-3">صاحب فاکتور :</div>
                                    <div class="font-size-lg font-weight-bold mb-10">{{$user->name ?? ''}} {{$user->lname ?? ''}}<br />{{$user->address ?? ''}}<br />{{$user->tel ?? ''}} </div>
                                    <!--end::Invoice To-->

                                    <!--begin::Invoice No-->
                                    <div class="text-dark-50 font-size-lg font-weight-bold mb-3">شماره فاکتور :</div>
                                    <div class="font-size-lg font-weight-bold mb-10">{{$project->id ?? ''}}</div>
                                    <!--end::Invoice No-->

                                    <!--begin::Invoice Date-->
                                    <div class="text-dark-50 font-size-lg font-weight-bold mb-3">تاریخ :</div>
                                ...
                                <div class="col-md-9 py-10 pl-md-10">
                                    <div class="table-responsive">
                                        <table class="table">
                                            <thead>
                                            <tr>
                                                <th class="pt-1 pb-9 pl-0 pl-md-5 font-weight-bolder text-muted font-size-lg text-uppercase">عنوان پروژه</th>
                                                <th class="pt-1 pb-9 text-right font-weight-bolder text-muted font-size-lg text-uppercase">اتمام پروژه</th>
                                                <th class="pt-1 pb-9 text-right font-weight-bolder text-muted font-size-lg text-uppercase">قیمت</th>
                                                <th class="pt-1 pb-9 text-right font-weight-bolder text-muted font-size-lg text-uppercase">کمیسیون</th>
                                                <th class="pt-1 pb-9 text-right pr-0 font-weight-bolder text-muted font-size-lg text-uppercase">مبلغ کل</th>
                                            </tr>
                                            </thead>
                                            <tbody>
                    ...
                    <div class="row justify-content-center border-top py-4 px-8 py-md-8 px-md-0">
                        <div class="col-md-9">
                            <div class="d-flex font-size-sm flex-wrap">
                                <button type="button" class="btn btn-outline-primary w-110px font-weight-bolder py-4 mr-3 mr-sm-14 my-1" onclick="window.print();">چاپ</button>
                                <a href="{{url("owner/project/$project->id/pay")}}" class="btn btn-success w-110px font-weight-bolder ml-sm-auto my-1 pt-4">پرداخت</a>
                            </div>
                        </div>
                    </div>
