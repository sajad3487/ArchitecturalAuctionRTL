                        ...
                        <form class="form" action="
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title" class="form-control form-control-solid" value="{{old('title') ?? $project->title ?? ''}}" placeholder="عنوان پروژه"  required/>
                                </div>
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="country" required
                                                ...
                                                <option value="" selected>انتخاب نمایید
                                                </option>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>اندازه پروژه (مترمربع) :</label>
                                            <input type="number" value="{{old('size') ?? $project->size ?? ''}}" @if(isset($project)) disabled @endif name="size" class="form-control form-control-solid" placeholder="اندازه پروژه" required/>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label>آدرس :</label>
                                    <input type="text" name="address" class="form-control form-control-solid" placeholder="آدرس پروژه" value="{{old('address') ?? $project->address ?? ''}}" required/>
                                </div>
                                <div class="form-group">
                                    <label for="exampleTextarea">توضیحات پروژه :</label>
                                ...
                                <div class="form-group">
                                    <label for="exampleTextarea">اهداف پروژه :</label>
                                    <textarea name="objective" class="form-control form-control-solid" rows="3" >{{old('objective') ?? $project->objective ?? ''}}</textarea>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        <label for="exampleTextarea">تاریخ اتمام شرکت در پروژه:</label>
                                        <div class="">
                                            <input type="text" name="deadline" class="form-control" id="kt_datepicker_1"  readonly placeholder="انتخاب تاریخ" value="{{old('deadline') ?? $project->deadline ?? ''}}" required/>
                                        </div>
                                    </div>
...
{{--                                </div>--}}
                            ...
                            <div class="card-footer text-center">
                                <a href="@if(isset($project)) {{url("owner/project/$project->id/view")}}@else{{url('owner/project')}}@endif" class="btn btn-secondary w-100px">لغو</a>
                                <button type="submit" class="btn btn-success ml-2 w-100px">ذخیره</button>
                            </div>
                        </form>
