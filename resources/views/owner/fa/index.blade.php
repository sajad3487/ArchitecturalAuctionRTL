                        ...
                        <div class="card card-custom ">
                            <div class="card-body rounded p-0 d-flex bg-light justify-content-between">
                                <div
                                    ...
                                    <h3 class="font-weight-bolder text-dark mb-3">جستجوی پروژه:</h3>
                                ...
                                <!--begin::Form-->
                                    <form action="{{url('/owner/project/search')}}" method="get" class="d-flex flex-center py-2 px-6 bg-white rounded">
                                        ...
                                        <input type="text" name="search" class="form-control border-0 font-weight-bold pl-2" placeholder="پروژه مورد نظر خود را جستجو نمایید"/>
                                    </form>
                                    <!--end::Form-->
                                </div>
