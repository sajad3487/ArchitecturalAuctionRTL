...
<head>
    ...
    <link href="{{asset('css/themes/layout/header/base/dark.rtl.css?v=7.0.6')}}" rel="stylesheet" type="text/css"/>
    <link href="{{asset('css/themes/layout/header/menu/dark.rtl.css?v=7.0.6')}}" rel="stylesheet" type="text/css"/>
...
<div class="d-flex flex-column flex-root">
    ...
    <div class="d-flex flex-row flex-column-fluid page">
        ...
        @include('layouts.admin.fa.Sidebar')

        <!--begin::Wrapper-->
        <div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper">

            @include('layouts.admin.fa.Header')

            @yield('content')


            @include('layouts.admin.fa.Footer')
        </div>
        <!--end::Wrapper-->
    </div>
    <!--end::Page-->
...
@include('layouts.admin.fa.rightSidebar')
