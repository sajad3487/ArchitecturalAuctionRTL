        ...
        <div
            ...
            <ul class="menu-nav ">
                ...
                <li class="menu-item @if(isset($active) && $active == 2)menu-item-active @endif " aria-haspopup="true"><a href="{{url('admin/users')}}" class="menu-link "><span class="svg-icon menu-icon">
                        ...
                        </svg><!--end::Svg Icon--></span><span class="menu-text">مشتریان</span></a>
                </li>
                ...
                <li class="menu-item @if(isset($active) && $active == 3)menu-item-active @endif " aria-haspopup="true"><a href="{{url('admin/categories')}}" class="menu-link "><span class="svg-icon menu-icon">
                        ...
                        </svg><!--end::Svg Icon--></span><span class="menu-text">دسته بندی</span></a>
                </li>
                <li class="menu-item @if(isset($active) && $active == 4)menu-item-active @endif " aria-haspopup="true"><a href="{{url('admin/project')}}" class="menu-link "><span class="svg-icon menu-icon">
                        ...
                        </svg><!--end::Svg Icon--></span><span class="menu-text">پروژه ها</span></a>
                </li>
            </ul>
            <!--end::Menu Nav-->
        </div>
