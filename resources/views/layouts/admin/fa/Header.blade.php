            ...
            <div class="dropdown" id="kt_quick_search_toggle">
                ...
                <div class="topbar-item" data-toggle="dropdown" data-offset="10px,0px">
                    <div class="btn btn-icon btn-clean btn-lg btn-dropdown mr-1">
		        				<span class="svg-icon svg-icon-xl svg-icon-primary"><!--begin::Svg Icon | path:assets/media/svg/icons/عمومی/جستجو.svg--><svg
            ...
            <div class="topbar-item">
                <div class="btn btn-icon btn-icon-mobile w-auto btn-clean d-flex align-items-center btn-lg px-2"
                    ...
                    <span class="symbol symbol-lg-35 symbol-25 symbol-light-success">
                        ...
                        @if(isset($user) && $user->profile_picture == null)
                            <span class="symbol-label font-size-h5 font-weight-bold">س</span>
                        @else
