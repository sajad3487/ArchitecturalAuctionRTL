                            ...
                            <ul class="nav nav-tabs nav-bold nav-tabs-line nav-tabs-line-3x">
                                ...
                                <li class="nav-item mr-3">
                                    <a class="nav-link" data-toggle="tab" href="#kt_user_edit_tab_3">
                                        ...
                                        <span class="nav-text font-size-lg">دیوار</span>
                                    </a>
                                </li>
                                <!--end::Item-->
                            </ul>
                            ...
                            <div class="tab-pane show active px-7" id="kt_user_edit_tab_1" role="tabpanel">
                                <div class="pb-5 px-5">
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <h1 class="text-success">{{$project->net_price ?? ''}} تومان </h1>
                                            <h4>قیمت</h4>
                                        </div>
                                        @if($project->deadline > now())
                                            @if($proposal != null)
                                            <a href="{{url("designer/proposal/$project->id/create")}}" class="btn btn-outline-warning h-40px mr-2 w-100px mt-md-2 col-6 col-md-2 ml-auto" >نمایش طرح ارسالی</a>
                                                @else
                                                <a href="{{url("designer/proposal/$project->id/create")}}" class="btn btn-outline-success h-40px mr-2 w-100px mt-md-2 col-6 col-md-2 ml-auto" >ارسال طرح</a>

                                            @endif
                                        @else
                                            <button  class="btn btn-outline-success h-40px mr-2 w-100px mt-md-2 col-6 col-md-2 ml-auto"  disabled>ارسال طرح</button>
                                        @endif
                                    </div>
                                    <div class="row mt-10 ">
                                        <div class="col-12">
                                    ...
                                    <div class="row mt-5">
                                        <h6 class="col-md-3">مهلت ارسال طرح:</h6>
                                                ...
                                                @foreach($walls as $wall)
                                                    <div class="comment-post my-4">
                                                        ...
                                                        <div class="comment-details">
                                                            <p><span class="comment-author">@if($wall->user_id == $user->id){{$user->name ?? 'شما'}} {{$user->fname ?? ''}}@else طراح شماره : {{$wall->user_id ?? ''}}@endif</span><span class="comment-time"></span></p>
                                                                            ...
                                                                            <div class="card-body">
                                                                                <form action="{{url("designer/wall/store")}}" method="post">
                                                                                    ...
                                                                                    <div class="field-comment mb-3">
                                                                                        ...
                                                                                        <button type="submit" class="btn btn--blue btn--medium pull-right">سوال خود را ارسال نمایید</button>
                                                                                    </div>
                                                                                </form>
                                                                            </div>
                                                                        </div>
