                        ...
                        <form class="form" action="
                            ...
                            <div class="card-body">
                                <div class="px-5">
                                    <div class="row">
                                        <div class="col-md-8">
                                            <h3>عنوان پروژه: {{$project->title ?? ''}}</h3>
                                            <h6>{{$project->subtitle ?? ''}}</h6>
                                        </div>
                                        <div class="col-md-4">
                                            <h3 class="text-success">{{$project->net_price ?? ''}} تومان </h3>
                                            <h4>قیمت</h4>
                                        </div>
                                    </div>
                                    <hr>
                                ...
                                <hr>
                                <div class="pt-5 px-5">
                                    <h3 class="mb-5">طرح خود را ارسال کنید:</h3>
                                    <div class="form-group">
                                        <label>عنوان</label>
                                        <input type="text" name="title" class="form-control form-control-solid" value="{{old('title') ?? $proposal->title ?? ''}}" placeholder="عنوان طرح "/>
                                    </div>
                                    <input type="number" name="project_id" value="{{$project->id}}" class="d-none">
                                    <div class="form-group">
                                        <label for="exampleTextarea">توضیحات طرح :</label>
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="custom-file">
                                                                                    ...
                                                                                    <label class="custom-file-label" for="file_input_0">انتخاب کنید</label>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <div class="form-group row m-0">
                                                                <div class="col-lg-4">
                                                                    <a onclick="add_input()" data-repeater-create="" class="btn btn-sm font-weight-bolder btn-light-primary">
                                                                        <i class="la la-plus"></i>افزودن فایل بیشتر
                                                                    </a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                                        ...
                                                                        <ul class="navi navi-hover">
                                                                            <li class="navi-item">
                                                                                <a href="{{url($file->media_path)}}" class="navi-link" download>
                                                                                    ...
                                                                                    <span class="navi-text text-success">دانلود</span>
                                                                                </a>
                                                                            </li>
                                                                        </ul>
                                                                        <!--end::Navigation-->
                                                                ...
                                                                <div data-repeater-item class="form-group row align-items-center m-0">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="custom-file">
                                                                                <input type="file" name="file" class="custom-file-input" id="file_input_0"/>
                                                                                <label class="custom-file-label" for="file_input_0">انتخاب فایل</label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
