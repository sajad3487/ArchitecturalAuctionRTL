                    ...
                    <div class="col-xl-12 mb-6">
                        ...
                        <div class="card card-custom ">
                            <div class="card-body rounded p-0 d-flex bg-light justify-content-between">
                                <div class="d-flex flex-column flex-lg-row-auto w-auto w-lg-350px w-xl-450px w-xxl-650px py-10 py-md-6 px-6 px-md-20 pr-lg-0">
                                    <h1 class="font-weight-bolder text-dark mb-3">جستجو پروژه</h1>
                                ...
                                <!--begin::Form-->
                                    <form action="{{url('designer/project/search')}}" method="get" class="d-flex flex-center py-2 px-6 bg-white rounded">
                                        ...
                                        <input type="text" name="search" class="form-control border-0 font-weight-bold pl-2" placeholder="پروژه مورد نظرتان را جستجو کنید"/>
                                    </form>
                                    <!--end::Form-->
                                </div>
                                <div class="d-none d-md-flex flex-row-fluid bgi-no-repeat bgi-position-y-center bgi-position-x-left bgi-size-cover col-4"
                    ...
                    <div class="col-xl-12 mb-6">
                        ...
                        <div class="card card-custom ">
                            <div class="card-body rounded px-6 py-4 bg-light">
                                <div class="font-size-h4 mt-2 mr-4">دسته بندی :
                                    <a href="{{url("/home")}}" class="btn btn-outline-primary mx-2">همه</a>
                                    @if(isset($categories))
                                        ...
                                        <div class="d-flex justify-content-between flex-column h-100">
                                            ...
                                            <div class="h-100">
                                                ...
                                                <div class="d-flex flex-column flex-center" >
                                                    ...
                                                    <!--end::Image-->
                                                    <!--begin::Title-->
                                                    <a href="{{url("designer/project/$project->id/view")}}" class="card-title font-weight-bolder text-dark-75 text-hover-primary font-size-h4 m-0 pt-7 pb-1">
                                                        <h3>{{$project->title ?? ''}}</h3>
                                                    </a>
                                                    <p>دسته بندی : {{$project->category->title ?? ''}}</p>
                                                    <!--end::Title-->
                                                    ...
                                                    <!--end::Text-->
                                                    <h3 class="pcounter p-0 m-0 text-success" id="demo-{{$key}}"></h3>
                                                    ...
                                                    <script>
                                                        ...
                                                        var x{{$key}} = setInterval(function() {
                                                            ...
                                                            if (distance{{$key}} < 0) {
                                                                document.getElementById('demo-{{$key}}').innerHTML = "منقضی شده";
                                            ...
                                            <div class="d-flex flex-center mt-md-2" id="kt_sticky_toolbar_chat_toggler" data-toggle="tooltip" title="" data-placement="right" data-original-title="">
                                                <h6 class="col-6 px-0">قیمت : {{$project->net_price ?? ''}} تومان </h6>

                                                <a href="{{url("designer/project/$project->id/view")}}" class="btn btn-outline-primary font-weight-bolder font-size-sm py-3 px-14">نمایش</a>
                                            </div>
                                            <!--end::Footer-->
                                        </div>
                                        <!--end::Wrapper-->
                                        ...
                                        <div class="d-flex justify-content-between flex-column h-100">
                                            ...
                                            <div class="h-100">
                                                ...
                                                <div class="d-flex flex-column flex-center">
                                                    ...
                                                    <!--begin::Title-->
                                                    <a href="{{url("designer/project/$project->id/view")}}" class="card-title font-weight-bolder text-dark-75 text-hover-primary font-size-h4 m-0 pt-7 pb-1">{{$project->title ?? ''}}</a>
                                                    <!--end::Title-->
                                            ...
                                            <div class="d-flex flex-center" id="kt_sticky_toolbar_chat_toggler" data-toggle="tooltip" title="" data-placement="right" data-original-title="">
                                                ...
                                                <a href="{{url("designer/project/$project->id/view")}}" class="btn btn-outline-primary font-weight-bolder font-size-sm py-3 px-14">View</a>
                                            </div>
                                            <!--end::Footer-->
                                        </div>
                                        <!--end::Wrapper-->
