                        ...
                        <div class="card card-custom ">
                            <div class="card-body rounded p-0 d-flex bg-light justify-content-between">
                                <div
                                    ...
                                    <h1 class="font-weight-bolder text-dark m-0">برنده شده ها</h1>
                                        ...
                                        <div class="d-flex justify-content-between flex-column h-100">
                                            ...
                                            <div class="h-100">
                                                ...
                                                <div class="d-flex flex-column flex-center" >
                                                    ...
                                                    <h1 class="text-success">برنده شده اید</h1>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex justify-content-between flex-column h-100">
                                            ...
                                            <div class="h-100">
                                                ...
                                                <div class="d-flex flex-column flex-center">
                                                    ...
                                                    <div class="font-weight-bold text-dark-50 font-size-sm ">
                                                        <h6 class="mt-3">تمام شده در : {{date('Y-M-d', strtotime($project->deadline))}}</h6>
                                                    </div>
                                                    <!--end::Text-->
                                                </div>
                                                <!--end::Header-->
                                            ...
                                            <div class="d-flex flex-center" id="kt_sticky_toolbar_chat_toggler" data-toggle="tooltip" title="" data-placement="right" data-original-title="">
                                                <h6 class="col-6 m-0 p-0">قیمت : {{$project->net_price ?? ''}}  تومان </h6>
